...
class TasksServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.List = channel.unary_unary(
                '/flaap.v1alpha1.TasksService/List',
                request_serializer=flaap_dot_taskstore__pb2.ListRequest.SerializeToString,
                response_deserializer=flaap_dot_taskstore__pb2.ListResponse.FromString,
                )
        ...
        self.Status = channel.unary_unary(
                '/flaap.v1alpha1.TasksService/Status',
                request_serializer=flaap_dot_taskstore__pb2.StatusRequest.SerializeToString,
                response_deserializer=flaap_dot_taskstore__pb2.StatusResponse.FromString,
                )
...
def add_TasksServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'List': grpc.unary_unary_rpc_method_handler(
                    servicer.List,
                    request_deserializer=flaap_dot_taskstore__pb2.ListRequest.FromString,
                    response_serializer=flaap_dot_taskstore__pb2.ListResponse.SerializeToString,
            ),
            ...
            'Status': grpc.unary_unary_rpc_method_handler(
                    servicer.Status,
                    request_deserializer=flaap_dot_taskstore__pb2.StatusRequest.FromString,
                    response_serializer=flaap_dot_taskstore__pb2.StatusResponse.SerializeToString,
            ),
    }
...
class TasksService(object):
    ...
    def List(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/flaap.v1alpha1.TasksService/List',
            flaap_dot_taskstore__pb2.ListRequest.SerializeToString,
            flaap_dot_taskstore__pb2.ListResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def Status(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/flaap.v1alpha1.TasksService/Status',
            flaap_dot_taskstore__pb2.StatusRequest.SerializeToString,
            flaap_dot_taskstore__pb2.StatusResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
